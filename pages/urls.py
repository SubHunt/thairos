...
urlpatterns = [
    ...
    path('snacks/', views.snacks_brands, name='snacks_brands'),
    path('snacks/<slug:slug>/', views.snack_brand_detail,
         name='snack_brand_detail'),
    path('snacks-landing/', views.snacks_landing, name='snacks_landing'),
